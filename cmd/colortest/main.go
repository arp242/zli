...
func main() {
	...
	fmt.Print("Dim       ", zli.Colorize("22", zli.Dim), " ")
	fmt.Print("Italic    ", zli.Colorize("33", zli.Italic), " ")
	fmt.Print("Underline ", zli.Colorize("44", zli.Underline), " ")
	fmt.Print("Undercurl ", zli.Colorize("55", zli.Undercurl), " ")
	fmt.Print("\n        ")
	fmt.Print("Overline  ", zli.Colorize("66", zli.Overline), " ")
	fmt.Print("Reverse   ", zli.Colorize("77", zli.Reverse), " ")
	fmt.Print("Concealed ", zli.Colorize("88", zli.Concealed), " ")
	fmt.Print("StrikeOut ", zli.Colorize("99", zli.StrikeOut), " ")
